...
def app():
    ...
    url = "https://raw.githubusercontent.com/ITSAIDI/Textra_App/main/images/Last.png?token=GHSAT0AAAAAACPS7L5XEHZIWN4GN2DWYGX6ZTUYO4Q"
    st.image(url, width=1000)
    st.write("You can check documentation [here](https://textra.readthedocs.io/fr/latest/)")
